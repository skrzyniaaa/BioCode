...
function Egzaminy() {
  const egzaminy = [
    ...
    },
    {
      ...
      // rozwiazaniePlik: new URL('../assets/egzamin5.pdf', import.meta.url).href,
            ...
            <div className="exam-card" key={egz.id}>
              ...
              <div className="exam-actions">
                <button
                  ...
                  onClick={() => handlePobierz(egz.rozwiazaniePlik, `rozwiazanie_egz${egz.id}.pdf`)}
                >
                  Rozwiązanie
                </button>
                <button
